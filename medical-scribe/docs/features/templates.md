...
Obscura includes a template system for structuring clinical notes. Templates consist of fields that can be customized with prompts, formatting rules, and persistence settings
